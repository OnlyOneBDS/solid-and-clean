...
public class UpdateLeaveRequestCommandHandler : IRequestHandler<UpdateLeaveRequestCommand, Unit>
{
  ...
  public UpdateLeaveRequestCommandHandler(IMapper mapper, IAppLogger<UpdateLeaveRequestCommandHandler> appLogger, IEmailSender emailSender, ILeaveRequestRepository leaveRequestRepository, ILeaveTypeRepository leaveTypeRepository)
  {
    _mapper = mapper;
